...
Example:
two_sum([2, 7, 11, 15]*10**5 + [5, 7], 12), (400000, 400001)
"""
...
def two_sum(nums: list, target: int) -> tuple:
    ...
    #     x = target - key
    #     if x in temp.keys():
    #         return (temp[value], temp[x] )



# print(two_sum([2, 7, 11, 15], 9), (0, 1))
# print(two_sum([3, 2, 4], 6), (1, 2))
# print(two_sum([1]*10**2 + [2, 3], 5), (10**2, 10**2 + 1))
# print(two_sum([2, 7, 11, 15]*1**1 + [5, 7], 12), (4, 5))
# print(two_sum([1, 3], 4), (0, 1))
