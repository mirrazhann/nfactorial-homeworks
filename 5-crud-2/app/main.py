...
def delete_book(
    ...
    return RedirectResponse(url=f"/books?page=1", status_code=303)
...
def update_book(
    ...
    if book_id is None or book_id <= 0:
        datas["error"] = "Ошибка id книги, перезагрузите страницу или обратитесь в поддержку"
        return templates.TemplateResponse("books/edit.html", datas)
    ...
    if total_pages is None or total_pages <= 0:
        datas["error"] = "Некорректное число страниц!"
        return templates.TemplateResponse("books/edit.html", datas)
